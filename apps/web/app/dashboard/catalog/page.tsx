    ...
    <div className="space-y-6">
      ...
      {isLoading && viewMode === 'grid' && (
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {[...Array(8)].map((_, i) => (
            <div key={i} className="relative rounded-2xl bg-white border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700 animate-pulse p-4">
      ...
      {isLoading && viewMode === 'list' && (
        <div className="space-y-2">
          {[...Array(8)].map((_, i) => (
            <div key={i} className="relative rounded-2xl bg-white border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700 flex animate-pulse gap-4 p-4">
      ...
      {!isLoading && books.length === 0 && (
        <div className="relative rounded-2xl bg-white border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700 py-16 text-center">
          ...
          {books.map((book) => {
            ...
            return (
              <Link
                ...
                className="relative rounded-2xl bg-white border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700 transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 group flex flex-col p-4"
              >
          ...
          {books.map((book) => {
            ...
            return (
              <Link
                key={book.id}
                href={`/dashboard/catalog/${book.id}`}
                className="relative rounded-2xl bg-white border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700 transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 group flex items-center gap-4 p-3"
              >
